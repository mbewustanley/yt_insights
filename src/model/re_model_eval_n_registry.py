...
logger = logging.getLogger('model_evaluation_and_registration')
logger.setLevel('DEBUG')

console_handler = logging.StreamHandler()
console_handler.setLevel('DEBUG')

file_handler = logging.FileHandler('model_evaluation_and_registration_errors.log')
    ...
    with mlflow.start_run() as run:
        try:
            ...
            mlflow.sklearn.log_model(
                ...
                registered_model_name="yt_chrome_plugin_model"  # <-----This is actually what registers the model now. not mlflow.register_model()
                )
